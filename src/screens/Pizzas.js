...
export default function Foods({ navigation }) {
  ...
  const foods = [
    { id: 1, image: require('../pizzaimages/SP.jpeg'), title: 'Sausage Pizza', description: 'Pizza made with sausage and spices', price: 100.00 , quantity:1},
    { id: 2, image: require('../pizzaimages/vpizza.jpg'), title: 'Vegetarian Pizza', description: 'This is made for vegetarians and it is purely vege.', price: 200.00 },
    { id: 3, image: require('../pizzaimages/PBs.jpeg'), title: 'Pizza with Beef Small ', description: 'Tasty pizza with spicy beef and vegetables.', price: 80.00 },
    { id: 4, image: require('../pizzaimages/CP.jpg'), title: 'Chicken Pizza', description: 'Nice combination of pizza made with spicy chicken .', price: 120.00 },
    { id: 5, image: require('../pizzaimages/Ip.jpg'), title: 'Italian Pizza', description: 'A combination of intalian recipie', price: 80.00 },
    { id: 6, image: require('../pizzaimages/eggp.jpg'), title: 'Egg Pizza', description: 'A tasty pizza which is made with egg.', price: 100.00 },
    { id: 7, image: require('../pizzaimages/PBb.jpeg'), title: 'Pizza with Beef Big', description: 'Bigger size of the pizza with spicy beef', price: 250.00 },
    { id: 8, image: require('../pizzaimages/mrp.jpeg'), title: 'Mushroom Pizza', description: 'The pizza main ingredient is mushroom', price: 150.00 },
    { id: 9, image: require('../pizzaimages/PP.jpeg'), title: 'Pepperoni Pizza ', description: 'Nice pepperoni pizza with pepper ', price: 150.00 },
    { id: 10, image: require('../pizzaimages/CP.jpg'), title: 'Shrimps Pizza', description: 'Garnished shrimp tasty pizza', price: 150.00 }
  ];
            ...
            <View style={styles.modalView}>
              {selectedFood && (
                <>
                  ...
                  <Text style={styles.foodPrice}>GHC {selectedFood.price * quantity}</Text>
